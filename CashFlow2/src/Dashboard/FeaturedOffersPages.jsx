                ...
                <div className="container mx-auto px-4">
                    ...
                    {offers.map((offer, i) => (
                        ...
                        <img
                            src={offer.img}
                            alt={offer.title}
                            className="h-40 w-full object-cover opacity-80 group-hover:scale-105 transition"
                        />
                        ...
                        <div className="p-3 relative">
                            <div
                            className={`${offer.iconBg} absolute top-[-45px] w-10 h-10 rounded-xl flex items-center justify-center`}
                            >
                            <offer.icon className="w-5 h-5 text-black" />
                            </div>

                            <h3 className="text-white mb-3 text-[13px] line-clamp-1">
                            {offer.title}
                            </h3>

                            <button
                            className="w-full text-[13px] bg-gradient-to-r from-cyan-500 to-teal-400
